...
REM
REM Generated by Vivado on Tue Dec 02 21:53:33 +0100 2025
...
echo "xvlog --relax -L uvm -prj ste_dice_tb_vlog.prj"
call xvlog  --relax -L uvm -prj ste_dice_tb_vlog.prj -log xvlog.log
